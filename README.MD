...
1. Navigate to the project repl at https://replit.com/@dannygcordobap/ShopifyDeveloperInternChallenge-F22#.replit. Here you can view the source code and run the project. 
